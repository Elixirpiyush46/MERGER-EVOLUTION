...
console.log("Biome:", biome);
  ...
  const evolutionData = [
    { level: 0, display: 'Primordial\nMolecule', size: 15, scoreValue: 1, fact: 'The spark of chemistry.' },
    { level: 1, display: 'Amino\nAcid', size: 20, scoreValue: 1, fact: 'Building blocks of life.' },
    { level: 2, display: 'Protein', size: 25, scoreValue: 2, fact: 'Complex structures with purpose.' },
    { level: 3, display: 'RNA\nWorld', size: 30, scoreValue: 3, fact: 'Information starts to flow.' },
    { level: 4, display: 'DNA', size: 35, scoreValue: 5, fact: 'The code of life is written.' },
    { level: 5, display: 'Single\nCell', size: 42, scoreValue: 8, fact: 'Life takes its first breath.' },
    { level: 6, display: 'Multicellular\nLife', size: 50, scoreValue: 13, fact: 'Together, we become more.' },
    { level: 7, display: 'Fish', size: 58, scoreValue: 21, fact: 'Life explores the oceans.' },
    { level: 8, display: 'Amphibian', size: 65, scoreValue: 34, fact: 'First steps on land.' },
    { level: 9, display: 'Reptile', size: 72, scoreValue: 55, fact: 'Masters of the dry land.' },
    { level: 10, display: 'Dinosaur', size: 80, scoreValue: 89, fact: 'Giants rule the Earth.' },
    { level: 11, display: 'Mammal', size: 88, scoreValue: 144, fact: 'Warmth, care, and survival.' },
    { level: 12, display: 'Primate', size: 95, scoreValue: 233, fact: 'Smarter. Social. Curious.' },
    { level: 13, display: 'Human', size: 102, scoreValue: 377, fact: 'We imagine. We build. We dream.' },
    { level: 14, display: 'Cyborg', size: 110, scoreValue: 610, fact: 'Technology becomes part of us.' },
    { level: 15, display: 'Space\nColony', size: 118, scoreValue: 987, fact: 'We reach beyond our home.' },
    { level: 16, display: 'Planetary\nCivilization', size: 126, scoreValue: 1597, fact: 'A world united and advanced.' },
    { level: 17, display: 'Interstellar\nCivilization', size: 134, scoreValue: 2584, fact: 'Among the stars, we thrive.' },
    { level: 18, display: 'Galactic\nCivilization', size: 142, scoreValue: 4181, fact: 'A galaxy united in consciousness.' },
    { level: 19, display: 'Cosmic\nMind', size: 150, scoreValue: 6765, fact: 'We become one with the cosmos.' }
  ];
...
/>
  ...
  if (img) {
    ...
    const colors = ['#9d4edd', '#5a189a', '#3a0ca3', '#3c096c', '#5a189a', '#240046', '#10002b', '#06ffa5', '#10c876', '#1adb8a', '#1adb8a', '#26f26d', '#5dff61', '#ffc857', '#ffb700', '#ffa500', '#ff8c42', '#ff6b35', '#f7931e', '#00d9ff'];
    const color = colors[highestFruit] || '#00e5ff';
    ...
    ctx.fill();
          ...
          />
          <div style={styles.achievementName}>{evolutionData[highestFruit].display}</div>
          <div style={styles.achievementFact}>{evolutionData[highestFruit].fact}</div>
        </div>
      )}
  ...
  if (img) {
    ...
    ctx.fill();
        ...
        <div style={styles.canvasWrapper}>
          ...
          />
          <div style={styles.instruction}>Click to release lifeform</div>
        </div>
      </div>
      ...
      <div style={styles.controls}>
        ...
        <button
          ...
          style={{...styles.button, backgroundColor: soundEnabled ? '#27ae60' : '#95a5a6'}}
        >
...
const styles = {
  ...
  achievementBox: {
    background: 'linear-gradient(135deg, rgba(0, 100, 150, 0.8) 0%, rgba(100, 50, 150, 0.8) 100%)',
    borderRadius: '12px',
    padding: '20px',
    marginBottom: '20px',
    textAlign: 'center',
